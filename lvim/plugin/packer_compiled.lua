...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'Comment.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'todo-comments.nvim', 'nvim-lastplace', 'lsp_signature.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

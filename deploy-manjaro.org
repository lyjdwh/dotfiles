...
** base
   ...
   #+BEGIN_SRC sh
     sudo pacman -S vim zsh tmux google-chrome yay axel base-devel proxychains xclip xsel neovim anaconda emacs
     sudo pacman -S fzf thesilversearcher pandoc wakatime cmake ranger tldr neofetch adobe-source-code-pro-fonts visual-studio-code-bin
...
** fcitx
   ...
   #+BEGIN_SRC sh
     sudo pacman -S fcitx5 fcitx5-chinese-addons fcitx5-gtk fcitx5-qt fcitx5-pinyin-zhwiki fcitx5-pinyin-moegirl kcm-fcitx5
   #+END_SRC
...
** ranger
   ...
   #+BEGIN_SRC sh
     ...
     sudo pacman -S autojump ueberzug mpv imagemagick ffmpegthumbnailer highlight bat pygmentize atool unrar tar unzip w3m mediainfo
   #+END_SRC
...
** emacs
   ...
   #+BEGIN_SRC sh
     ...
     sudo pacman -S zeal aspell aspell-en
...
*** eaf
    ...
    #+BEGIN_SRC sh
      ...
      sudo pacman -S python-pyqt5 python-pyqt5-sip python-pyqtwebengine python-qrcode python-feedparser python-dbus python-pyinotify python-markdown nodejs aria2 libreoffice python-qtconsole filebrowser-bin wmctrl
...
** dwm
   ...
   #+BEGIN_SRC sh
     ...
     sudo pacman -S rofi xorg-xinput acpilight slock xautolock feh picom network-manager-applet xfce4-volumed-pulse flameshot goldendict redshift trayer dmenu
   #+END_SRC
...
** others
   ...
   #+BEGIN_SRC sh
     sudo pacman -S ncdu you-get youtube-dl ripgrep ripgrep-all qbittorrent okular texlive-most texlive-langchinese noto-fonts-emoji bleachbit

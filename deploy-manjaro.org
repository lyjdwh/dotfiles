...
** base
   ...
   #+BEGIN_SRC sh
     sudo pacman -S vim zsh tmux google-chrome tor-browser yay axel base-devel proxychains \
          xclip xsel neovim anaconda emacs-native-comp-nopgtk-git fzf the_silver_searcher pandoc-bin \
          cmake ranger tealdeer neofetch htop glances trash oath-toolkit tokei duf wakatime
...
** others
   ...
   #+BEGIN_SRC sh
     sudo pacman -S ncdu you-get yt-dlp ripgrep ripgrep-all qbittorrent \
          ...
          shellcheck-static mendeleydesktop-bundled hugo xmind-2021 downgrade procs
